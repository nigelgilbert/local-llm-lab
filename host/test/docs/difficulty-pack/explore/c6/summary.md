# Sprint 1.21 Explore — Cycle 6

Generated 2026-05-03T19:01:58.187Z from `run_registry.explore-c6-20260503-1400.jsonl` (6 rows).

Tiers in this cycle: 16, 32.  Tests: 1.

## Per-cell pass-rate matrix

| test_id | t16 pass | t16 status | t32 pass | t32 status |
|---|---|---|---|---|
| `needle-haystack` | 100% (3/3) | clean | 100% (3/3) | clean |
...
|---|---|---|---|---|---|---|---|---|---|
| `needle-haystack` | t16 | ⚠️ |  |  |  |  | ⚠️ | 8 | 12815 |
| `needle-haystack` | t32 | ⚠️ |  |  |  |  | ⚠️ | 6 | 12580 |
