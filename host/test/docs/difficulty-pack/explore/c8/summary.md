# Sprint 1.21 Explore — Cycle 8

Generated 2026-05-03T21:28:28.716Z from `run_registry.explore-c8-20260503-1625.jsonl` (3 rows).

Tiers in this cycle: 16, 32, 64.  Tests: 1.

## Per-cell pass-rate matrix

| test_id | t16 pass | t16 status | t32 pass | t32 status | t64 pass | t64 status |
|---|---|---|---|---|---|---|
| `cascade-eight` | 100% (1/1) | clean | 100% (1/1) | clean | 100% (1/1) | clean |
...
|---|---|---|---|---|---|---|---|---|---|
| `cascade-eight` | t16 | ⚠️ |  |  |  | ⚠️ | ⚠️ | 33 | 57261 |
| `cascade-eight` | t32 | ⚠️ |  |  |  | ⚠️ | ⚠️ | 30 | 51923 |
| `cascade-eight` | t64 | ⚠️ |  |  |  | ⚠️ | ⚠️ | 33 | 41283 |
