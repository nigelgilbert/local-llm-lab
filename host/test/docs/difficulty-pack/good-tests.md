...
**As of:** 2026-05-03 (post-c17 word-search v2.1 t16/t32 sniff)
...
`twelve-file-refactor`, `ini-parser`, `needle-haystack-v1`. Each saturates cleanly across the lineage but has a defeasible saturation strategy worth a v2 redesign attempt (see triage 2026-05-03):
